...
/**
 * Returns an array of all photo objects in the photos array.
 *
 * @returns {object[]} An array of photo objects, each with the id, title, and url properties.
 */
const getAllPhotos = () => {
...
/**
 * Returns the photo object with the specified id from the photos array.
 *
 * @param {string} id The id of the photo object to retrieve.
 * @returns {object} The photo object with the specified id, or null if no photo with the specified id exists.
 */
